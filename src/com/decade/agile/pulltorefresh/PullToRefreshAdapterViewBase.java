...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
	...
	public final void onScroll(final AbsListView view,
		...
		DZLog.d(getClass(), "First Visible: " + firstVisibleItem
	...
	public final void onScrollStateChanged(final AbsListView view,
		 ...
		 * visible.
		 */
		DZLog.d(getClass(), "mLastItemVisible="+mLastItemVisible + "state= "+state + mOnLastItemVisibleListener);
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			DZLog.d(getClass(), "isFirstItemVisible. Empty View.");
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			DZLog.d(getClass(), "isLastItemVisible. Empty View.");
			...
			DZLog.d(getClass(), "isLastItemVisible. Last Item Position: "

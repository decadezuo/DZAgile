 ...
 * @author Jeff Gilfelt
 */
public class DZBadgeView extends TextView {
	...
	public DZBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public DZBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public DZBadgeView(Context context, View target) {
     ...
     */
	public DZBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public DZBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public DZBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {

 ...
 */
public class DZLazyViewPager extends ViewGroup {
    ...
    /**
     * Simple implementation of the {@link android.support.v4.view.DZLazyViewPager.OnPageChangeListener} interface with stub
     * implementations of each method. Extend this if you do not intend to override
     * every method of {@link android.support.v4.view.DZLazyViewPager.OnPageChangeListener}.
     */
    ...
    public DZLazyViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public DZLazyViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
